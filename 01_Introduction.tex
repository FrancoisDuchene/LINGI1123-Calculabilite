...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\linewidth]{Images/detecteur_virus_p(drole)}
	\caption{Fonctionnement du programme \lstinline|drole| pour \lstinline|drole|}
	\label{fig:detecteurviruspdrole}
\end{figure}
%TODO Reproduire l'image en tikz
\begin{itemize}
